...
CAMLprim value gles_cull_face(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_clear_color(value v1, value v2, value v3, value v4)
{
...
CAMLprim value gles_uniform4fv(value v1, value v2)
{
    CAMLparam2 (v1, v2);
...
CAMLprim value gles_uniform2fv(value v1, value v2)
{
    CAMLparam2 (v1, v2);
...
CAMLprim value gles_uniform1i(value v1, value v2)
{
    CAMLparam2 (v1, v2);
...
CAMLprim value gles_buffer_data(value v1, value v2, value size, value v3)
{
...
CAMLprim value gles_enable(value v1)
{
    CAMLparam1 (v1);
    glEnable(Int_val(v1));
    CAMLreturn (Val_unit);
...
CAMLprim value gles_disable(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_draw_arrays(value mode, value offset, value count)
{
...
CAMLprim value gles_color_mask(value r, value g, value b, value a)
{
    CAMLparam4 (r, g, b, a);
...
CAMLprim value gles_front_face(value dir)
{
    CAMLparam1 (dir);
...
CAMLprim value gles_active_texture(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_stencil_mask(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_stencil_func(value v1, value v2, value v3)
{
    CAMLparam3 (v1, v2, v3);
...
CAMLprim value gles_stencil_op(value v1, value v2, value v3)
{
    CAMLparam3 (v1, v2, v3);
...
CAMLprim value gles_stencil_op_separate(value v1, value v2, value v3, value v4)
{
    CAMLparam4 (v1, v2, v3, v4);
...
CAMLprim value gles_blend_func_separate(value v1, value v2, value v3, value v4)
{
    CAMLparam4 (v1, v2, v3, v4);
...
CAMLprim value gles_pixel_storei(value v1, value v2)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_enable_vaa(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_disable_vaa(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_bind_buffer(value v1, value v2)
{
    CAMLparam2 (v1, v2);
...
CAMLprim value gles_use_program(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_tex_parameteri(value v1, value v2, value v3)
{
    CAMLparam3 (v1, v2, v3);
...
CAMLprim value gles_generate_mipmap(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_uniform_loc(value v1, value v2)
{
    CAMLparam2 (v1, v2);
...
CAMLprim value gles_create_program()
{
    CAMLparam0 ();
...
CAMLprim value gles_gen_textures(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_delete_textures(value v1)
{
    CAMLparam1 (v1);
    const long unsigned int size = Wosize_val(v1);
    GLuint* textures = malloc(size*sizeof(GLuint));
...
CAMLprim value gles_vertex_attrib_pointer(value index, value size, 
...
CAMLprim value gles_vertex_attrib_pointer_byte(value* argv, int argn)
{
    return gles_vertex_attrib_pointer(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5]);
}

CAMLprim value gles_tex_image2d(value target, value level, value internal, value width, value height, value border, value format, value type, value data)
{
...
CAMLprim value gles_tex_image2d_byte(value* argv, int nargs)
{
    return gles_tex_image2d(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]);
}

CAMLprim value gles_tex_subimage2d(value target, value level, value xoff, value yoff, value width, value height, value format, value type, value data)
{
...
CAMLprim value gles_tex_subimage2d_byte(value* argv, int nargs)
{
    return gles_tex_subimage2d(argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8]);
}

CAMLprim value gles_get_error()
{
    return CAMLprim(Val_int(glGetError()));
}

CAMLprim value gles_create_shader(value v1)
{
    CAMLparam1 (v1);
    CAMLreturn (Val_int(glCreateShader(Int_val(v1))));
}

CAMLprim value gles_shader_source(value shader, value source)
{
...
CAMLprim value gles_compile_shader(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_attach_shader(value prog, value shader)
{
...
CAMLprim value gles_get_shaderiv(value shader, value param)
{
...
CAMLprim value gles_link_program(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_get_programiv(value program, value param)
{
...
CAMLprim value gles_bind_attrib_location(value prog, value loc, value name)
{
...
CAMLprim value gles_delete_program(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_delete_shader(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_get_shader_info_log(value v1)
{
    CAMLparam1 (v1);
    GLint length = 0;
...
CAMLprim value gles_get_program_info_log(value v1)
{
    CAMLparam1 (v1);
    GLint length = 0;
...
CAMLprim value gles_gen_buffers(value v1)
{
    CAMLparam1 (v1);
...
CAMLprim value gles_bind_texture(value target, value tex)
{
...
CAMLprim value gles_buffer_data_null(value target, value size, value hint)
{
...
CAMLprim value gles_buffer_sub_data(value target, value offset, value size, value data)
{
...
CAMLprim value gles_uniform4fv_offset(value loc, value buf, value off, value sz)
{
...
CAMLprim value gles_get_integer(value name)
{
    CAMLparam1 (name);
...
CAMLprim value gles_uniform_block_binding(value program, value index, value binding)
{
...
CAMLprim value gles_bind_buffer_range(value target, value index, value buffer, value offset, value size)
{
...
CAMLprim value gles_create_vertex_array_object()
{
    CAMLparam0();
    GLuint vao = 0;
...
CAMLprim value gles_bind_vertex_array_object(value vao)
{
    CAMLparam1 (vao);
