(** This module is ready for use by user applications. It combines the {!module:Graphv_gles2_native_impl} module with the {!module:Graphv_font_stb_truetype} module to produce a new vector library.
*)
...
(** Creates a new renderer. Make sure the OpenGL context that is being used
    supports the stencil buffer.
 *)
